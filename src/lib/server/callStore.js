 ...
 * @param {Object} params
 * @param {string} params.blindUserId - Verified/generated blind user ID
 * @param {string} [params.callId] - Optional server-generated callId
 * @param {number} [params.ttlSeconds=600] - Expiry TTL in seconds
 * @returns {Promise<{ callId: string, status: 'pending', blindUserId: string, claimedBy: null, createdAt: number }>}
 */
export async function createCallState({ blindUserId, callId = null, ttlSeconds = DEFAULT_CALL_TTL_SECONDS }) {
 ...
 * @param {string} callId
 * @param {string} volunteerUserId
 * @returns {Promise<{ success: boolean, call?: Object, reason?: string }>}
 */
export async function claimCallState(callId, volunteerUserId) {
 ...
 */
export function _resetMemoryCallStoreForTesting() {
