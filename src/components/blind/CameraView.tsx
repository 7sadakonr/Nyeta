...
import { formatCurrencyDisplay, formatCurrencySpeech, ParsedCurrency } from '@/lib/currencyUtils';
import { BlindMode, BoundingBox, DetectedObject, QuadCorners, AssistantStatus } from '@/types/assistant';
