...
import { formatCurrencySpeech, formatTotalSpeech, ParsedCurrency } from '@/features/blind-assistant/client/currencyUtils';
import speechManager, { Priority } from '@/shared/accessibility/speechManager';
import { ScannedItem, BoundingBox } from '@/features/blind-assistant/types/assistant';
